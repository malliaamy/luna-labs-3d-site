...
function w() {
    ...
    return (0, b.useEffect)(() => {
        ...
        L.setMeshoptDecoder(v), L.load(`./assets/dragon-tower-web-v2.glb?v=meshopt-20260808`, e => {
            ...
            let q = [];
            c.forEach((e, t) => {
                let n = e.parent?.name || e.name || `unnamed`;
                q.length && q[q.length - 1][0] === n ? q[q.length - 1][2] = t : q.push([n, t, t])
            });
            document.title = `MESHES ` + JSON.stringify(q), n.current = c, window.__lunaMeshInfo = c.map((e, t) => ({
                i: t,
                name: e.name,
