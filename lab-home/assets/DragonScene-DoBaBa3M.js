...
function w() {
    ...
    return (0, b.useEffect)(() => {
        ...
        L.setMeshoptDecoder(v), L.load(`./assets/dragon-tower-web-v2.glb?v=meshopt-20260808`, e => {
            ...
            aa.current = new Set([`Head`, `Tail`, `Body`, `Wing1`, `Wing2`].map(e => t.getObjectByName(e)).filter(e => e instanceof y));
        ...
        ee.observe(b);
        return W(), () => {
            I = !0, window.clearTimeout(Z), cancelAnimationFrame(H), ee.disconnect(), z.disconnect(), window.removeEventListener(`scroll`, V), B.removeEventListener(`change`, V), O.dispose(), O.domElement.remove(), Object.values(A).forEach(e => e.dispose()), t.current = null, n.current = [], aa.current.clear()
        }
    }, []), (0, b.useEffect)(() => {
        let e = w.current;
        e.resin && n.current.forEach(t => {
            let r = aa.current.has(t);
